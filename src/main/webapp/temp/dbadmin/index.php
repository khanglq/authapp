...
<tr><th>',lang(31),'<td>',html_select("auth[driver]",$Xb,DRIVER,"loginDriver(this);"),'<tr><th>',lang(32),'<td><input  type="hidden" name="auth[server]" value="127.9.37.2:3306" title="hostname[:port]" placeholder="localhost" autocapitalize="off">
<tr><th>',lang(33),'<td><input type="hidden" name="auth[username]" id="username" value="root" autocapitalize="off">
<tr><th>',lang(34),'<td><input type="hidden" name="auth[password]" value="root">
<tr><th>',lang(35),'<td><input type="hidden" name="auth[db]" value="evisa';?>" autocapitalize="off">
</table>
...
';switch_lang();if($ue!="auth"){echo'<form id="" action="" method="post">
<p class="logout">
